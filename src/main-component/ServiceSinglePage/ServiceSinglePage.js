    ...
    "Services": [
      {
        ...
        "sSimg":"https://tse4.mm.bing.net/th?id=OIP.CisTLGeqxhVDvKMqfBVyDwHaE8&pid=Api&P=0&h=180",
       "ssImg1": "https://tse1.mm.bing.net/th?id=OIP.R2Pnbg-8M-0RSwx6j35rBgHaEo&pid=Api&P=0&h=180",
       "ssImg2":"https://tse2.mm.bing.net/th?id=OIP.tdBsFKKH6R2MRAar_db3IAHaE3&pid=Api&P=0&h=180",
                            ...
                            <div className="service-single-wrap">
                                <div className="service-single-item">
                                    <div className="service-single-main-img">
                                        <img src={serviceDetailsdata.sSimg} height={600} width={1170} alt="" />
                                    </div>
                                    ...
                                    <div className="row mt-4">
                                        <div className="col-md-6 col-sm-6 col-12">
                                            <div className="p-details-img">
                                                <img src={serviceDetailsdata.ssImg1} height={390} width={570} alt="" />
                                            </div>
                                        </div>
                                        <div className="col-md-6 col-sm-6 col-12">
                                            <div className="p-details-img">
                                                <img src={serviceDetailsdata.ssImg2} height={390} width={570} alt="" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
